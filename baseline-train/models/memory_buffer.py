...
class PPOMemory:
    ...
    def __init__(self, bs):
        ...
        self.v = []
        self.p = []
        self.pi = []  # optional improved policy (e.g., from MCTS)
        self.r = []
        self.t = []

        self.bs = bs 

    def remember(self, s,a,v,p,pi,r,t):
        '''
    ...
    def get_batches(self):
        ...
        return self.s, self.a, self.v, \
            self.p, self.pi, self.r, self.t, batch_idxs
...
class MultiPPOMemory:
    ...
    def remember(self, idx, *args):
        # Expect signature: s, a, v, p, pi, r, t
    ...
    def get_batches(self): 
        ...
        return all_s, all_a, all_v, all_p, all_pi, all_r, all_t, idxs